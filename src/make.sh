...
gcc -I . -g -fPIC -Wl,-e,tst_start -nostdlib -shared -o tst-rtld-recorder.so tst/tst-rtld-recorder.c tst/tst-rtld-recorder.S lib/printf.c lib/lock.c lib/util.c lib/buf.c -Wl,--no-undefined -Wall -fvisibility=hidden

gcc -I . binary.c -o binary
...
./binary rtld rtld public/tst-rtld.h

gcc -I . tst/tst-rtld.S -o tst-rtld -nostdlib -fPIE -pie -Wall -Wl,-e,start -g -D ERI_TST_RTLD
