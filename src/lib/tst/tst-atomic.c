...
main (void)
{
  ...
  eri_atomic_and (&u8, 9);
  eri_atomic_and (&u16, 9);
  eri_atomic_and (&u32, 9);
  eri_atomic_and (&u64, 9);
  ...
  int64_t s64 = -1;
  eri_atomic_and (&s64, 0xffffffff);
  eri_assert (s64 == 0xffffffff);
  s64 = -1;
  eri_atomic_and (&s64, 0x100000000);
  eri_assert (s64 == 0x100000000);
  s64 = -1;
  eri_atomic_and (&s64, -1);
  eri_assert (s64 == -1);
  ...
  eri_assert (! eri_atomic_bit_test_set (&u16, 0));
  eri_assert (! eri_atomic_bit_test_set (&u32, 0));
  eri_assert (! eri_atomic_bit_test_set (&u64, 0));
  eri_assert (u16 == 3);
  eri_assert (u32 == 3);
  eri_assert (u64 == 3);
  ...
  eri_assert (eri_atomic_bit_test_set (&u16, 1));
  eri_assert (eri_atomic_bit_test_set (&u32, 1));
  eri_assert (eri_atomic_bit_test_set (&u64, 1));
  eri_assert (u16 == 2);
  eri_assert (u32 == 2);
  eri_assert (u64 == 2);
  ...
  eri_assert (eri_atomic_exchange (&u8, 1) == 2);
  eri_assert (eri_atomic_exchange (&u16, 1) == 2);
  eri_assert (eri_atomic_exchange (&u32, 1) == 2);
  eri_assert (eri_atomic_exchange (&u64, 1) == 2);
  eri_assert (u8 == 1);
  eri_assert (u16 == 1);
  eri_assert (u32 == 1);
  eri_assert (u64 == 1);
  ...
  eri_assert (! eri_atomic_compare_exchange (&u8, 1, 3));
  eri_assert (! eri_atomic_compare_exchange (&u16, 1, 3));
  eri_assert (! eri_atomic_compare_exchange (&u32, 1, 3));
  eri_assert (! eri_atomic_compare_exchange (&u64, 1, 3));
  eri_assert (u8 == 2);
  eri_assert (u16 == 2);
  eri_assert (u32 == 2);
  eri_assert (u64 == 2);
